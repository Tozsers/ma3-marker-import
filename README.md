...
If the sequence name is not found, the plugin lists the sequences that *are* in the
loaded show — usually that is enough to spot the typo, or that a different show is open
than you thought.
